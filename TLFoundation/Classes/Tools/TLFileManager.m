...
{
    return [[TLFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[TLFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[TLFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[TLFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[TLFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[TLFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
